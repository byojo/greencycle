...
CREATE TABLE IF NOT EXISTS `exchange_items` (
  ...
  `image`        VARCHAR(255)    NOT NULL                       COMMENT '商品图片 URL（COS 公有读桶：https://greencycle-image-1255464850.cos.ap-guangzhou.myqcloud.com/exchange/xxx.png）',
...
('环保帆布袋', '可循环使用的棉布购物袋，减少一次性塑料袋使用', 'https://greencycle-image-1255464850.cos.ap-guangzhou.myqcloud.com/exchange/bag.png', 200, 100, 5, 1, 1),
('碳中和徽章', '绿循环官方认证碳中和徽章，佩戴即环保', 'https://greencycle-image-1255464850.cos.ap-guangzhou.myqcloud.com/exchange/badge.png', 500, 200, 5, 2, 1),
('绿植种子套装', '包含 3 种适合家养的绿植种子，共建绿色家园', 'https://greencycle-image-1255464850.cos.ap-guangzhou.myqcloud.com/exchange/seeds.png', 800, 50, 5, 3, 1),
('保温杯', '不锈钢真空保温杯，随手环保从一杯热水开始', 'https://greencycle-image-1255464850.cos.ap-guangzhou.myqcloud.com/exchange/cup.png', 1500, 30, 5, 4, 1),
('电动牙刷', '声波震动牙刷，环保从每一次刷牙开始', 'https://greencycle-image-1255464850.cos.ap-guangzhou.myqcloud.com/exchange/toothbrush.png', 3000, 20, 5, 5, 1);
