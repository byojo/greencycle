...
('环保帆布袋', '可循环使用的棉布购物袋，减少一次性塑料袋使用', '/assets/exchange/bag.png', 200, 100, 1, 1, 1),
('碳中和徽章', '绿循环官方认证碳中和徽章，佩戴即环保', '/assets/exchange/badge.png', 500, 200, 1, 2, 1),
('绿植种子套装', '包含 3 种适合家养的绿植种子，共建绿色家园', '/assets/exchange/seeds.png', 800, 50, 2, 3, 1),
('保温杯', '不锈钢真空保温杯，随手环保从一杯热水开始', '/assets/exchange/cup.png', 1500, 30, 1, 4, 1),
('电动牙刷', '声波震动牙刷，环保从每一次刷牙开始', '/assets/exchange/toothbrush.png', 3000, 20, 1, 5, 1);
